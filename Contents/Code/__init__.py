...
EUROLIVEF = 'http://www.euronews.net/media/player_live_1_11.swf?lng=fr'
EUROLIVE = 'http://www.euronews.net/media/player_live_1_11.swf?lng=en'
...
def MainMenu():
    oc = ObjectContainer()
    oc.add(VideoClipObject(url = EUROLIVE, title = 'Euronews live stream (English)'))
    oc.add(VideoClipObject(url = EUROLIVEF, title = 'Euronews live stream (French)'))   
